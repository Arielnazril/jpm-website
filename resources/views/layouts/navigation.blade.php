<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('bisnis')" :active="request()->routeIs('bisnis')">
                        {{ __('Bisnis') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4">
                ...
                @guest
                    <a href="{{ route('login') }}"
                       class="text-gray-700 dark:text-gray-300 hover:text-blue-600 font-medium transition duration-150 ease-in-out">
                       Login
                    </a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('bisnis')" :active="request()->routeIs('bisnis')">
                {{ __('Bisnis') }}
            </x-responsive-nav-link>
