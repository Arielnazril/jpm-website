...
<head>
    ...
    <style>
        ...
        nav.navbar {
            ...
            padding: 10px 0; /* Perkecil padding jika logo sudah memberikan tinggi yang cukup */
            transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            border-bottom: 3px solid var(--color-primary);
        }
        @media (max-width: 768px) {
    .navbar-brand img {
        height: 50px; /* Logo kembali mengecil di layar HP agar rapi */
    }
    .navbar-brand span {
        font-size: 0.9rem; /* Mengecilkan teks di samping logo jika perlu */
    }
}
    ...
    <div class="container">
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="footer-logo-section">
                    ...
                    <div class="social-links mt-4 d-flex gap-3">
                        <a href="https://wa.me/6281234567890" target="_blank" title="Chat via WhatsApp">
                            <img src="{{ asset('images/wa.png') }}" alt="WhatsApp" 
                                style="width: 35px; height: 35px; border-radius: 8px; object-fit: cover;">
                        </a>
                        
                        <a href="mailto:info@jasaprimamakmur.com" title="Kirim Email">
                            <img src="{{ asset('images/gmail.jpg') }}" alt="Gmail" 
                                style="width: 35px; height: 35px; border-radius: 8px; object-fit: cover;">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
                <h4 style="color: #FFA500; font-weight: 800; font-size: 1.1rem; text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 30px;">
                    Tautan Cepat
                </h4>
                <ul style="list-style: none; padding: 0;">
                    ...
                    <li style="margin-bottom: 15px;"><a href="{{ url('/bisnis') }}" style="color: #ddd;"><i class="bi bi-chevron-right me-2" style="color: #FFA500;"></i> Bisnis Kami</a></li>
                    <li style="margin-bottom: 15px;"><a href="{{ url('/proyek') }}" style="color: #ddd;"><i class="bi bi-chevron-right me-2" style="color: #FFA500;"></i> Proyek</a></li>
                    <li style="margin-bottom: 15px;"><a href="{{ url('/kontak') }}" style="color: #ddd;"><i class="bi bi-chevron-right me-2" style="color: #FFA500;"></i> Kontak</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div style="background: #1a1a1a; padding: 25px; border-radius: 15px; border: 1px solid #333;">
                    <p style="color: #ddd; margin-bottom: 15px; display: flex; align-items: flex-start; gap: 12px;">
                        <i class="bi bi-geo-alt-fill" style="color: #FFA500;"></i>
                        <span>Jasa Prima Makmur Office, Indonesia</span>
                    </p>
                    <p style="color: #ddd; margin-bottom: 15px; display: flex; align-items: center; gap: 12px;">
                        <i class="bi bi-envelope-fill" style="color: #FFA500;"></i>
                        <span>info@jasaprimamakmur.com</span>
                    </p>
                    <p style="color: #ddd; margin: 0; display: flex; align-items: center; gap: 12px;">
                        <i class="bi bi-telephone-fill" style="color: #FFA500;"></i>
